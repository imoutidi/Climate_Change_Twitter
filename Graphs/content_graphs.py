...
def index_query():
    ...
    tweets_subset = all_tweets_ids[800000:900000]
    ...
    for nn_index_id in range(20):
        print("LSH index number: " + str(nn_index_id))
        ...
        for idx, tweet_id in enumerate(tweets_subset):
            print(idx)
            ...
            try:
                labels, distances = current_nn_index.knn_query(bert_array, k=800)
    ...
    tools.save_pickle(r"C:\Users\irmo\PycharmProjects\Climate_Change_Twitter\I_O\Datasets\LSH_files\\"
                      r"Computations\labels_distances_dict_8", labels_distances_dict)
